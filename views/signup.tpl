...
<form role="form" method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="username" placeholder="Username" name="username" value="{{username}}" maxlength="30">
  </div>
  <div class="form-group">
    <label for="email">Email Address</label>
    <input type="email" class="form-control" id="email" placeholder="Email ID (won't be publicly displayed)" name="email" value="{{email}}">
  </div>
  <div class="form-group">
...
<br />
		<br />
          Already a user? <a href="/login">Log in</a>.<p>
          <hr />

      		</div>
		  </div><!-- centering the posts in the middle -->
		</div>
