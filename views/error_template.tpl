      ...
      <div class="starter-template">
	      <div class="row">
 			 <div class="col-md-6 col-md-offset-3"><!-- centering the posts in the middle -->
 			 	...
 			 	<img src="https://cdn3.iconfinder.com/data/icons/tango-icon-library/48/face-sad-512.png" alt="sad face" width="400px" height="400px" />
 			 	<a href="/" class="noLinkDec"><button type="button" class="btn btn-danger btn-lg">Take Me Home</button></a>
			 </div>
		  </div>
      </div>
